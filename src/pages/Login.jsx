                ...
                <div className='w-full max-w-md bg-white dark:bg-brand-card p-8 sm:p-10 rounded-3xl shadow-card border border-slate-200/80 dark:border-brand-border'>
                    <div className='text-center mb-8'>
                        ...
                        <p className='text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1'>
                            Log in to your Shopsy account to continue shopping
                        </p>
                    </div>
                    ...
                    <div className='mt-6 p-4 bg-slate-50 dark:bg-brand-dark/50 rounded-2xl border border-slate-200/60 dark:border-brand-border/60 text-center text-xs text-slate-500 dark:text-slate-400 space-y-1'>
                        <p className='font-bold text-slate-800 dark:text-slate-200 mb-1'>Demo Credentials:</p>
                        <p>Customer: <code className='text-primary font-semibold'>user@shopsy.com</code> / <code className='text-primary font-semibold'>User123!</code></p>
                        <p>Admin: <code className='text-primary font-semibold'>admin@shopsy.com</code> / <code className='text-primary font-semibold'>Admin123!</code></p>
                    </div>
                </div>
            </main>
